...
const COPY: Readonly<Record<Locale, ProtocolLabCopy>> = {
  ja: {
    ...
    phase: 'フェーズ',
    overview:
      '宣言済みfixture profileとprotocol outcomeは比較開始時から表示します。stage、timestamp、Region Raft／MVCC、client応答、background cleanupは選択したexact event時点の状態です。',
    ...
    selectionProfile: '宣言済みfixture profile / outcome（固定）',
    requestId: '合成Request ID',
    transactionId: '合成Transaction ID',
    selectedProtocol: '宣言済みprotocol outcome',
    laneStage: 'Exact-event stage（時間変化）',
    featureFlags: '宣言済みの有効候補',
    enabled: 'ON',
    fixtureShape: '宣言済み集計fixture',
    aggregateMutations: '集計mutation',
    totalKeyBytes: '合計key bytes',
    regions: 'Regions',
    eligibility: '宣言済みeligibility outcome',
    eligible: '対象',
    ineligible: '対象外',
    selectionReason: '宣言済みoutcomeの根拠',
    decisionPoints: '宣言済み判定点',
    rpcFlags: '宣言済みrequest形状 / 除外',
    sent: 'true',
    notSent: 'false',
    rejected: '除外',
    accepted: '除外なし',
    clientPrecheck: 'client precheck',
    limits: '宣言済みAsync Commit client既定上限',
    keys: 'keys',
    bytes: 'bytes',
    runtimeFallback: '宣言済みruntime fallback outcome',
    no: 'なし',
    yes: 'あり',
    timestamps: 'Exact-event timestamp（時間変化）',
    pending: '未確定',
    notUsed: 'この方式では未使用',
    modelBound: 'MODEL境界',
    clientPath: 'Exact-event client境界',
    clientAwaiting: '応答待ち',
    clientResponded: 'commit応答済み',
    backgroundPath: 'Exact-event背景cleanup',
  ...
  en: {
    ...
    phase: 'Phase',
    overview:
      'Declared fixture profiles and protocol outcomes are visible from comparison start. Stage, timestamps, Region Raft/MVCC, client response, and background cleanup show the selected exact-event state.',
    ...
    selectionProfile: 'Declared fixture profile / outcome (static)',
    requestId: 'Synthetic request ID',
    transactionId: 'Synthetic transaction ID',
    selectedProtocol: 'Declared protocol outcome',
    laneStage: 'Exact-event stage (temporal)',
    featureFlags: 'Declared enabled candidates',
    enabled: 'ON',
    fixtureShape: 'Declared aggregate fixture',
    aggregateMutations: 'aggregate mutations',
    totalKeyBytes: 'total key bytes',
    regions: 'Regions',
    eligibility: 'Declared eligibility outcome',
    eligible: 'eligible',
    ineligible: 'ineligible',
    selectionReason: 'Declared outcome rationale',
    decisionPoints: 'Declared decision points',
    rpcFlags: 'Declared request shape / exclusions',
    sent: 'true',
    notSent: 'false',
    rejected: 'rejected',
    accepted: 'not rejected',
    clientPrecheck: 'client precheck',
    limits: 'Declared Async Commit client defaults',
    keys: 'keys',
    bytes: 'bytes',
    runtimeFallback: 'Declared runtime-fallback outcome',
    no: 'No',
    yes: 'Yes',
    timestamps: 'Exact-event timestamps (temporal)',
    pending: 'Pending',
    notUsed: 'Not used by this protocol',
    modelBound: 'MODEL bound',
    clientPath: 'Exact-event client boundary',
    clientAwaiting: 'Awaiting response',
    clientResponded: 'Committed response sent',
    backgroundPath: 'Exact-event background cleanup',
